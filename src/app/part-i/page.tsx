...
export const metadata: Metadata = {
  ...
  description:
    "Forensic dissection of r/ForbiddenBromance: 102,610 artifacts across 83 months showing a Lebanese-Israeli 'dialogue' community whose pulse tracks the battlefield, not its people. Every figure sourced from a live database.",
};
